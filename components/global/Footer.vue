...
.grid {
  ...
  @media (min-width: 768px) {
    ...
    justify-items: center;
    gap: 4rem;
    align-items: center; /* Center items vertically in grid for desktop */
  }
}
...
.heading {
  font-size: 1.4rem;
  font-weight: 600; /* Muted font weight */
  color: #80868b; /* Muted gray color */
...
.socials {
  ...
  justify-content: center;
  margin-top: 1rem; /* Align visual center with no header */
