                    ...
                    <div v-for="item in chatBotResults" :key="item.id + '-' + item.media_type" class="carousel-item">
                      ...
                      <a v-if="item.media_type === 'movie'"
                        ...
                        <div class="poster-wrapper">
                          ...
                          <img v-else src="https://github.com/imprvhub/entercinema/blob/main/static/image_not_found_yet_es.webp?raw=true" :alt="item.title || 'Movie Poster Not Found'">
                      ...
                      <a v-else-if="item.media_type === 'tv'"
                        ...
                        <div class="poster-wrapper">
                          <img v-if="item.poster_path" 
                               ...
                               @error="handleImageError">
                          <img v-else src="https://github.com/imprvhub/entercinema/blob/main/static/image_not_found_yet_es.webp?raw=true" :alt="item.name || 'TV Show Poster Not Found'">
                      ...
                      <a v-else-if="item.media_type === 'person'"
                        ...
                        <div class="profile-wrapper">
                          <img v-if="item.profile_path" 
                               ...
                               @error="handleImageError">
                          <img v-else src="https://github.com/imprvhub/entercinema/blob/main/static/image_not_found_yet_es.webp?raw=true" :alt="item.name || 'Person Profile Not Found'">
...
export default {
  ...
  methods: {
    handleImageError(event) {
      const fallbackUrl = 'https://github.com/imprvhub/entercinema/blob/main/static/image_not_found_yet_es.webp?raw=true';
