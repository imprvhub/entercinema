    ...
    <div class="error-content">
      ...
      <div class="error-message">
        <p v-if="error.statusCode === 504">
          It appears we are unable to fetch the data at the moment. Please check your internet connection or try again later.
        </p>
        <p v-else-if="error.statusCode === 404">
          The page you're looking for doesn't exist or has been moved.
        </p>
        <p v-else>
          It seems you have followed a broken link or entered a URL that doesn't exist on this site. Also can be that there is an issue with your internet connection.
        </p>
      </div>
      
      <div class="error-actions">
        <nuxt-link to="/" class="home-button">Return to Home</nuxt-link>
      </div>
    </div>
  </div>
</template>
