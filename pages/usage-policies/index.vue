  ...
  <main class="main">
    <section class="terms-section">
      ...
      <div>
        ...
        <h2 class="text-center">Users are solely responsible for interpreting and acting upon metadata or third-party information. <strong>IN NO EVENT SHALL EnterCinema, ITS CONTRIBUTORS, OR AFFILIATES BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES ARISING OUT OF OR RELATED TO YOUR USE OF THE PLATFORM OR ANY ANALYTICS DATA PROCESSED THROUGH IT.</strong></h2>
