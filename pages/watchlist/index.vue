...
export default {
  ...
  data() {
    return {
      ...
      fallbackImageUrl: "https://github.com/imprvhub/entercinema/blob/main/static/image_not_found_yet_es.webp?raw=true",
      handleImageError: "this.src='https://github.com/imprvhub/entercinema/blob/main/static/image_not_found_yet_es.webp?raw=true'",
      userEmail: '',
      accessToken: '',
      isLoggedIn: false,
      favorites: [],
