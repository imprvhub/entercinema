<template>
  <main class="main">
    <section class="section">
      ...
      <div class="user-info">
        <div class="avatar-container">
          <div class="avatar-wrapper">
            <img :src="userAvatar"  @click="openAvatarModal" alt="User Avatar" class="avatar">
          </div>
        </div>
        <button @click="openAvatarModal" class="change-avatar-button">Change Avatar</button>
        <!-- Modal -->
        <div class="modal" v-if="isModalOpen">
          <div class="modal-content">
            <span class="close" @click="closeAvatarModal">&times;</span>
            <h2 style="text-align: center;">Select your Avatar</h2>
        ...
        <div class="modal-delete" v-if="isDeleteModalOpen">
          <div class="modal-delete-content">
            ...
            <div class="button-container">
              ...
              <button @click="confirmDelete" class="button button-delete-account">Confirm</button>
            </div>
          </div>
        </div>
      ...
      <div class="button-container">
        <button @click="back" class="button button-back">Back</button>
        <button @click="deleteAccount" class="button button-delete-account">Delete Account</button>
      </div>
    </section>
  </main>
</template>
